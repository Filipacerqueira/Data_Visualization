...
# World Bank Data
df_social_progress_index = pd.read_excel('2014-2019-SPI-Public.xlsx', sheet_name='Social Progress Index')
df_final = pd.read_excel('Final df.xlsx')

df_basic_human_needs = pd.read_excel('2014-2019-SPI-Public.xlsx', sheet_name='Basic Human Needs')
df_foundations_of_wellbeing = pd.read_excel('2014-2019-SPI-Public.xlsx',
                                            sheet_name='Foundations of Wellbeing')
df_opportunity = pd.read_excel('2014-2019-SPI-Public.xlsx', sheet_name='Opportunity')

data_2016 = pd.read_csv('cost-of-living-2016.csv')
data_2017 = pd.read_csv('cost-of-living-2017.csv')
data_2018 = pd.read_csv('cost-of-living-2018.csv')

# Importing Human Development Index DataFrame
df_hdi = pd.read_csv('human-development-index.csv', header=0, quotechar="'")
...
df_temperature = pd.read_csv('avg_temperature.csv', header=0, sep=';')
...
df_precipitation = pd.read_csv('API_AG.LND.PRCP.MM_DS2_en_csv_v2_620809.csv')

df_data_scientist_salary = pd.read_excel('Data Scientists GROSS Anual Compensation Around the World.xlsx')
df_wage = pd.read_excel('wage.xlsx')
df_wage1 = df_wage.melt(id_vars='Country',
                        var_name='Year',
                        value_name='Wage')

df_happiness_score = pd.read_excel('Hapiness Score.xlsx')
